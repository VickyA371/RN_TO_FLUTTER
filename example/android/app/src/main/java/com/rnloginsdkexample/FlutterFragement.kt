...
class RNFlutterFragment(
  ...
  override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
    ...
    if (initialJson != null) {
      flutterCounterApi?.setJson(initialJson) {}
    }
  ...
  inner class HostCounterApiHandler(
    ...
    override fun setText(text: String) {
      ...
      sendEventToReact(MyViewManager.COMMAND_TEXT, event)
    }

    override fun setJson(json: String) {
      val event = Arguments.createMap().apply {
        putString("value", json)
      }
      sendEventToReact(MyViewManager.COMMAND_JSON, event)
    }
    ...
    override fun setScreen(screen: String) {
      ...
      sendEventToReact(MyViewManager.COMMAND_SCREEN, event)
    }
    ...
    override fun setClicks(value: Long) {
      ...
      sendEventToReact(MyViewManager.COMMAND_CLICKS, event)
    }
